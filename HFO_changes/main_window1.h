...
#define _MAX_UDP_DGRAM_BYTES 8192
#define TCP_IMAGE_SEND

#include <QMainWindow>

#include "main_data.h"

// Includes for socket operations: (Orr)
#include <QtNetwork>
#include <QUdpSocket>
...
protected:
    // Variables for controlling TCP socket to send out images (Orr)
# ifdef TCP_IMAGE_SEND
    QTcpServer img_server;
    QTcpSocket* img_socket[2];
    int img_sock_ind;
# endif
    QUdpSocket* img_udp_socket;
